...
        {/* ==========================
        ...
        <Route element={<ProtectedRoute />}>
            ...
            {/* This should be the default route for ALL logged-in users */}
            <Route path="/" element={<Navigate to="/dashboard" replace />} />
            
            {/* --- 1. PET OWNER SIDE (Accessible to ALL logged-in users) --- */}
            <Route path="/dashboard" element={<Dashboard />} />
            <Route path="/listing/:id" element={<ListingInfo />} />
            
            
            {/* --- 2. SERVICE PROVIDER SIDE (Strictly guarded by roles/application status) --- */}
            ...
            {/* This guard should ONLY allow access if the user IS a provider or is in the setup flow */}
            ...
            {/* --- 3. ADMIN SIDE --- */}
            {/* Assuming these are guarded by Admin-specific logic, but they are separate routes */}
